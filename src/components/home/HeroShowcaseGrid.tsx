...
const columns = [
  {
    ...
    students: [
      { name: 'Jerome Adonis', major: 'CIS Major', img: '/images/cis-student-success/jerome-adonis-aws-profile.jpeg' },
      { name: 'Francis Boadu', major: 'Biology Major', img: '/images/biology-student-success/francis-boadu-duke-research.png' },
      { name: 'Sally Adenutsi', major: 'Mathematics', img: '/images/math-student-success/sally-adenutsi-profile.jpeg' },
      { name: 'Jerome Adonis', major: 'CIS Major', img: '/images/cis-student-success/jerome-adonis-aws-profile.jpeg' },
      { name: 'Francis Boadu', major: 'Biology Major', img: '/images/biology-student-success/francis-boadu-duke-research.png' },
    ],
  },
  {
    ...
    students: [
      { name: 'Kamar Goudelock', major: 'Business & STEM', img: '/images/business-student-success/kamar-goudelock-wells-fargo-internship.jpeg' },
      { name: 'Jephter Ofori', major: 'CIS Fellow', img: '/images/cis-student-success/jephter-ofori-syngenta-profile.jpeg' },
      { name: 'Robert Osei', major: 'Biology Major', img: '/images/biology-student-success/robert-osei-poe-center-internship.jpeg' },
      { name: 'Kamar Goudelock', major: 'Business & STEM', img: '/images/business-student-success/kamar-goudelock-wells-fargo-internship.jpeg' },
      { name: 'Jephter Ofori', major: 'CIS Fellow', img: '/images/cis-student-success/jephter-ofori-syngenta-profile.jpeg' },
    ],
  },
  {
    ...
    students: [
      { name: 'Francis Suapim', major: 'Mathematics', img: '/images/math-student-success/francis-suapim-profile.png' },
      { name: 'Emmanuel Amponsah', major: 'Business & STEM', img: '/images/business-student-success/emmanuel-amponsah-business-profile.jpeg' },
      { name: 'Naomi Nuhamin Bullo', major: 'Biology Major', img: '/images/biology-student-success/naomi-nuhamin-bullo-profile.jpeg' },
      { name: 'Francis Suapim', major: 'Mathematics', img: '/images/math-student-success/francis-suapim-profile.png' },
      { name: 'Emmanuel Amponsah', major: 'Business & STEM', img: '/images/business-student-success/emmanuel-amponsah-business-profile.jpeg' },
    ],
  },
